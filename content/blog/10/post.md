...
It depends your project’s type, what you want to do, who you develop the software for and many more things. Here is a list of ideas you can try or even combine to make money with your open-source projects. Hopefully that helps you to free more time for the things you love to work on.
...
It’s used by hundreds of developers, companies and even a few big corporations, but we earned less than $300 through PayPal donations over the last three years. Don’t get me wrong, we are very thankful for every dollar, but this makes an hourly rate of less than $1. That’s not sustainable, and definitely not enough to work less on client projects and more on the bespoken project.
...
## Support
Some developers or companies need support to use your software. You can offer them support contracts, e. g. to promise a short response time for bug reports or availability for calls. Some companies require this level of support, some will use it extensively and some won’t ever use it at all.

Offering support can work well for teams, but can be a distraction from the work they are good at for single developers.

## Contracting
If you open-sourced something like a complex library, companies might want to hire you to help to implement your solution in their system. They know that you are the expert for the software you’ve written and happily pay you, even if it’s more than an average freelancer rate.

If you enjoy open-source because you didn’t want to work with clients, that’s probably not for you. On the other hand, you’ll always use your code, which will help get better insights into how your software can be improved.
...
## Sponsored features
People always request features. Try turning feature requests in sponsored work, and offer to add those features for money. If multilpe users or companies requested the same feature, you can even offer them to share the development costs. Don’t forget to mention your sponsors in the release notes!
